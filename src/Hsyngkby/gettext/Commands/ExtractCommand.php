...
class ExtractCommand extends Command {
    ...
    public function fire ()
    {
        ...
        {
            // throw exception
            throw new \Hsyngkby\gettext\NoFilesToExtractFromException("No templates found");
        ...
        if (!$process->isSuccessful())
            throw new \Hsyngkby\gettext\XgettextException("The xgettext command could not be executed:" . PHP_EOL .
